...
const (
	NodeService_ReturnStatus_FullMethodName = "/NodeService/returnStatus"
	NodeService_AssignTask_FullMethodName   = "/NodeService/AssignTask"
)
...
type NodeServiceClient interface {
	ReturnStatus(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
...
func (c *nodeServiceClient) ReturnStatus(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, NodeService_ReturnStatus_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NodeServiceServer interface {
	ReturnStatus(context.Context, *Request) (*Response, error)
...
func (UnimplementedNodeServiceServer) ReturnStatus(context.Context, *Request) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReturnStatus not implemented")
}
...
func _NodeService_ReturnStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NodeServiceServer).ReturnStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NodeService_ReturnStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NodeServiceServer).ReturnStatus(ctx, req.(*Request))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _NodeService_ReturnStatus_Handler,
		},
	},
